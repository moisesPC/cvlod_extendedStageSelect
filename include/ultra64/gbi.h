...
/*
 * HACK:
 * self is a dreadful hack. For version 1.0 hardware, there are still
 ...
 * display lists!)
 *
 * self WILL BE REMOVED FOR HARDWARE VERSION 2.0!
 */
#define BOWTIE_VAL  0
...
/*
 *
 * self magic value is the maximum INTEGER z-range of the hardware
 ...
 *
 * self number is DIFFERENT than G_MAXFBZ, which is the maximum value
 ...
 * self can also be exploited to handle odd-sized viewports.
 *
...
/*
 * self union is the fundamental type of the display list.
 ...
 *
 * self command makes all othermode parameters set.
